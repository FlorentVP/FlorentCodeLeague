  ...
  return (
    <div className="slideshow">
      <video
        ...
        src="https://github.com/nolan-chapter-two/assets/releases/download/League_Sizzle/Florent.League.Promo.3.mp4"
        autoPlay
        muted
        loop
        playsInline
    ...
    <div id="fvp-root" className="wrapper">
      ...
      <div className="sponsors">
        ...
        <div className="sponsors-grid">
          ...
          <div className="sponsor-item">
            <img src="/logos/kth-ais.png" alt="KTH AIS" style={{height: '56px', maxWidth: '180px'}} />
          </div>
